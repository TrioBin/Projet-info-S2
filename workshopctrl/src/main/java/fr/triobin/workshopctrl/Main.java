...
public class Main {
    public static void main(String[] args) {
        Machine machine1 = new Machine(new RefMachine("M1"), "Machine 1", new Position(1, 1), new Cost(1), new ArrayList<Operation>(), Machine.MachineStatus.AVAILABLE);
        Machine machine2 = new Machine(new RefMachine("M2"), "Machine 2", new Position(2, 2), new Cost(2), new ArrayList<Operation>(), Machine.MachineStatus.AVAILABLE);
        Machine machine3 = new Machine(new RefMachine("M3"), "Machine 3", new Position(3, 3), new Cost(3), new ArrayList<Operation>(), Machine.MachineStatus.AVAILABLE);
